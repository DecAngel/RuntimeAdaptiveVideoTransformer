...
class VisualizeCallback(pl.Callback):
    ...
    def get_batch_visualize_image_and_ids(self, batch: BatchTDict, pred: BatchTDict):
    ...
    def on_start(self, stage: SubsetLiteral):
        self.stage = stage

    def on_step(self, batch: BatchTDict, pred: BatchTDict):
    ...
    def on_train_batch_end(
        self, trainer: "pl.Trainer", pl_module: "pl.LightningModule", outputs: BatchTDict, batch: BatchTDict, batch_idx: int
    ) -> None:
