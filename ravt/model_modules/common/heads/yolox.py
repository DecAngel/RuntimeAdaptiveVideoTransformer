...
from ..layers import BaseConv, DWConv
from ..losses import IOUloss
from ravt.common.array_operations import xyxy2cxcywh, clip_or_pad_along
...
class YOLOXHead(nn.Module):
    ...
    def forward(
        ...
        if self.training:
            ...
            return {
                'pred_coordinates': pred_coordinates.float(),
                'pred_probabilities': pred_probabilities.float(),
