...
from ravt.core.constants import BatchDict, ComponentTypes
...
class KorniaAugmentation(BaseTransform):
    def __init__(
            self,
            train_component_types: Tuple[ComponentTypes] = ('image', 'bbox'),
            train_aug: Optional[ka.VideoSequential] = None,
            train_resize: Optional[ka.VideoSequential] = None,
            eval_component_types: Tuple[ComponentTypes] = ('image',),
