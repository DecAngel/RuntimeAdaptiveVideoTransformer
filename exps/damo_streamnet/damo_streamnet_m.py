...
from ravt.systems.yolox import damo_streamnet_m
...
def main(
    ...
    """ Train and test damo_streamnet_m model on Argoverse-HD
    ...
    if train:
        system.load_from_pth(
            Path(root_dir) / 'weights' / 'pretrained' / 'yolox_m_drfpn.pth'
        )
        res = run_train(
