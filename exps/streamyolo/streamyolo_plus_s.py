...
from ravt.systems.yolox import streamyolo_plus_s
...
def main(
    ...
    """ Train and test streamyolo_plus_s model on Argoverse-HD
    ...
    system = streamyolo_plus_s(
        data_source=ArgoverseDataSource(enable_cache=False),
    ...
    res = run_train(
        ...
        callback_ema=True, callback_visualize=visualize, resume=None,
    )
    print(res)
